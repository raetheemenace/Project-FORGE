...
- [ ] 5. Build Student Dashboard
  ...
  - [ ] 5.3 Create live clock hook
    - Implement frontend/src/hooks/useClock.js with 1-second interval updates
    - _Requirements: 3.6_

- [ ] 6. Implement Borrow an Item flow - Step 1 (Department Selection)
  - [ ] 6.1 Create BorrowStep1 component
...
- [ ] 7. Implement Borrow an Item flow - Step 2 (Borrowing Details)
  - [ ] 7.1 Create BorrowStep2 component
  ...
  - [ ] 7.2 Write property test for past date rejection
    - **Property 4: Past date rejection**
    - **Validates: Requirements 5.4**

- [ ] 8. Implement AI Equipment Scanner
  - [ ] 8.1 Create scanner backend endpoint
  ...
  - [ ] 8.2 Create BorrowStep3 component
  ...
  - [ ] 8.3 Write property test for scanned items cart growth
    - **Property 8: Scanned items cart growth**
    - **Validates: Requirements 6.4**

- [ ] 9. Implement Borrow an Item flow - Step 4 (Review Summary)
  - [ ] 9.1 Create transaction creation endpoint
  ...
  - [ ] 9.2 Create BorrowStep4 component
...
- [ ] 11. Implement My Transactions page
  ...
  - [ ] 11.3 Write property test for transaction list ordering
    - **Property 9: Transaction list ordering**
    - **Validates: Requirements 9.1**

- [ ] 12. Implement maintenance reporting
  - [ ] 12.1 Create maintenance report endpoint
    - Implement POST /api/maintenance to create maintenance report
    - Validate Severity and Description fields
    - _Requirements: 10.5, 10.6_
  
  - [ ] 12.2 Create ReportMaintenance component
...
- [ ] 16. Checkpoint - Ensure all student-facing features are working
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 17. Implement Admin Dashboard
  - [ ] 17.1 Create admin dashboard endpoint
  ...
  - [ ] 17.3 Write property test for admin role authorization
    - **Property 13: Admin role authorization**
    - **Validates: Admin access control**

- [ ] 18. Implement Equipment Management
  - [ ] 18.1 Create equipment CRUD endpoints
...
- [ ] 19. Implement Transaction Oversight
  ...
  - [ ] 19.2 Create TransactionOversight component
...
- [ ] 20. Implement Maintenance Ticket Management
  - [ ] 20.1 Create maintenance ticket endpoints
  ...
  - [ ] 20.2 Create MaintenanceTickets component
  ...
  - [ ] 20.3 Write property test for maintenance ticket lifecycle
    - **Property 15: Maintenance ticket lifecycle**
    - **Validates: Maintenance workflow integrity**

- [ ] 21. Implement User Management
...
- [ ] 22. Implement Lab Room Management
  ...
  - [ ] 22.2 Create LabRoomManagement component
    - Implement frontend/src/pages/admin/LabRoomManagement.jsx with room table
    - Add create/edit/deactivate functionality
    - _Requirements: 15.7_

- [ ] 23. Implement System Reports and Audit Log
  - [ ] 23.1 Create analytics and audit endpoints
  ...
  - [ ] 23.2 Create SystemReports component
  ...
  - [ ] 23.3 Write property test for admin action audit completeness
    - **Property 16: Admin action audit completeness**
    - **Validates: Admin accountability**

- [ ] 24. Implement UI components library
